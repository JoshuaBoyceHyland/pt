	...
	while (window.isOpen())
	{
		...
		while (window.pollEvent(event))
		{
			...
			case sf::Event::KeyPressed:
				...
				{
					DEBUG_MSG("gpp::Events::Event::BEHIND_ATTACK_EVENT");
					input.setCurrent(gpp::Events::Event::LIGHT_ATTACK_EVENT);
				}
				// stomp attack
				else if(sf::Keyboard::isKeyPressed(sf::Keyboard::O))
				{
					DEBUG_MSG("gpp::Events::Event::STOMP_ATTACK_EVENT");
					input.setCurrent(gpp::Events::Event::KICK_ATTACK_EVENT);
				}

				// special ability
				else if(sf::Keyboard::isKeyPressed(sf::Keyboard::E))
				{
					DEBUG_MSG("gpp::Events::Event::SpecialAbilityPlayerState.cpp");
					input.setCurrent(gpp::Events::Event::SPECIAL_ABILITY_START_PLAYER_STATE_);
				}
					 ...
					 sf::Keyboard::isKeyPressed(sf::Keyboard::Space)))
				{
					...
					input.setCurrent(gpp::Events::Event::JUMP_RUN_EVENT);
			...
			case sf::Event::KeyReleased:
				...
				{
					DEBUG_MSG("gpp::Events::Event::SPECIAL_ABILITY_STOP_PLAYER_STATE_");
					input.setCurrent(gpp::Events::Event::SPECIAL_ABILITY_STOP_PLAYER_STATE_);
				}
